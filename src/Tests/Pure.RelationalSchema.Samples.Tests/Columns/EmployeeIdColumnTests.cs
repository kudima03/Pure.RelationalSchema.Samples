...
public sealed record EmployeeIdColumnTests
{
    [Fact]
    public void NameIsEmployeeId()
    {
        IColumn column = new EmployeeIdColumn();

        Assert.Equal("employee_id", column.Name.TextValue);
    }
